...
import { Section } from "./Privacy_Policy";
...
function PrintButton() {
 ...
 function TermsConditions() {
  const sections: Section[] = [
    { id: "agreement", title: "Acceptance of Terms", body: <p>By using CalcVerse, you agree to these Terms and Conditions.</p> },
    { id: "use", title: "Permitted Use", body: <p>You may use the calculators for personal, non-commercial purposes only.</p> },
    { id: "content", title: "Content Accuracy", body: <p>We do not guarantee accuracy and are not liable for reliance on results.</p> },
    { id: "modifications", title: "Modifications", body: <p>We may update or modify the site at any time without notice.</p> },
    { id: "termination", title: "Termination", body: <p>Access may be suspended for violation of terms.</p> },
    { id: "governing", title: "Governing Law", body: <p>These terms are governed by applicable local laws.</p> },
  ];
