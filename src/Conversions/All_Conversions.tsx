                    ...
                    <div className="flex-1 flex-col justify-center mt-1 mb-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3 mr-4 ml-4 bg-white/80 dark:bg-gray-700 backdrop-blur-md rounded-3xl shadow-2xl border-slate-200 dark:border-gray-700 p-8 relative overflow-hidden transition-all duration-300 ease-in-out ">
                            <div className="flex flex-col items-center justify-center min-h-auto min-w-auto border border-teal-700 shadow-lg rounded-md mt-4 ml-5 mr-5 p-5 bg-gradient-to-br from-teal-100 to-blue-100 dark:from-teal-900/30 dark:to-blue-900/30 transition-all duration-300 ease-in-out">
                                <Link to="/All-calculators/Currency-Converter" className="self-start"><h2 className="dark:text-white/90 font-bold flex flex-col sm:text-sm md:text-sm lg:text-lg self-start hover:underline transition-all duration-200 ease-in-out ">Currency Converters</h2></Link>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full ">
                                    <div className="flex flex-col gap-2 mt-4 ">
                                        <Link to="/All-calculators/Currency-Converter" title="US Dollar to Indian Rupee"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">INR</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="US Dollar to Euro"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">EUR</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="US Dollar to Great Britain Pound"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">GBP</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="US Dollar to Japanese Yen"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">JPY</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="US Dollar to Swiss franc"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">CHF</span></p></Link>
                                    </div>
                                    <div className="flex flex-col gap-2 md:mt-4">
                                        <Link to="/All-calculators/Currency-Converter" title="US Dollar to Canadian dollar"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">USD</span> to <span className="font-bold">CAD</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="US Dollar to New Zealand dollar"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">USD</span> to <span className="font-bold">NZD</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="Euro to Great Britain Pound"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">EUR</span> to <span className="font-bold">GBP</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="Euro to Japanese yen"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">EUR</span> to <span className="font-bold">JPY</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="Australian Dollar to Swiss franc"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">AUD</span> to <span className="font-bold">CHF</span></p></Link>
                                        <Link to="/All-calculators/Currency-Converter" title="More Currency Converters"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out">More.....</p></Link>
