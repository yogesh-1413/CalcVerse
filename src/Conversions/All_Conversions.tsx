                            ...
                            <div className="flex flex-col items-center justify-center min-h-auto min-w-auto border border-teal-700 shadow-lg rounded-md mt-4 ml-5 mr-5 p-5 bg-gradient-to-br from-teal-100 to-blue-100 dark:from-teal-900/30 dark:to-blue-900/30 transition-all duration-300 ease-in-out">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full ">
                                    <div className="flex flex-col gap-2 mt-4 ">
                                        <Link to="/All-calculators/Currency-Calculators" title="US Dollar to Indian Rupee"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">INR</span></p></Link>
                                        <Link to="/All-calculators/Currency-Calculators" title="US Dollar to Euro"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">EUR</span></p></Link>
                                        <Link to="/All-calculators/Currency-Calculators" title="US Dollar to Great Britain Pound"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">GBP</span></p></Link>
                                        <Link to="/All-calculators/Currency-Calculators" title="US Dollar to Japanese Yen"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">JPY</span></p></Link>
                                        <Link to="/All-calculators/Currency-Calculators" title="US Dollar to Swiss franc"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"> <span className="font-bold ">USD</span> to <span className="font-bold">CHF</span></p></Link>
                                    </div>
                                    <div className="flex flex-col gap-2 md:mt-4">
                                        <Link to="/All-calculators/Currency-Calculators" title="US Dollar to Canadian dollar"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">USD</span> to <span className="font-bold">CAD</span></p></Link>
                                        <Link to="/All-calculators/Currency-Calculators" title="US Dollar to New Zealand dollar"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">USD</span> to <span className="font-bold">NZD</span></p></Link>
                                        <Link to="/All-calculators/Currency-Calculators" title="Euro to Great Britain Pound"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">EUR</span> to <span className="font-bold">GBP</span></p></Link>
                                        <Link to="/All-calculators/Currency-Calculators" title="Euro to Japanese yen"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">EUR</span> to <span className="font-bold">JPY</span></p></Link>
                                        <Link to="/All-calculators/Currency-Calculators" title="Australian Dollar to Swiss franc"><p className="dark:text-white ml-3 text-sm md:text-md lg:text-md hover:underline transition-all duration-300 ease-in-out"><span className="font-bold ">AUD</span> to <span className="font-bold">CHF</span></p></Link>
