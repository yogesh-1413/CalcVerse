  ...
  return (<div className='flex flex-col'>
    ...
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-800">SIP Calculator</h2>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">{formatCurrency(monthlyInvestment)}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 space-y-4 border border-green-100">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-bold text-green-600">{formatCurrency(result.estimatedReturns)}</span>
            </div>
            <div className="h-px bg-green-200"></div>
            <div className="flex justify-between items-center">
              <span className="text-gray-700 font-semibold">Total Value</span>
              <span className="text-2xl font-bold text-green-700">{formatCurrency(result.totalValue)}</span>
            </div>
          </div>
        </div>

        <div>
          <h3 className="text-lg font-semibold text-gray-700 mb-4">Investment Growth</h3>
